...
class Betaoutexport_Exporter_Helper_Data extends Mage_Core_Helper_Abstract
{
   public $error_file = '';
   
    public function __construct()
    {
		$this->error_file = Mage::getBaseDir('var') .'/betaoutexport/exporter/order_exception_log.htm';
