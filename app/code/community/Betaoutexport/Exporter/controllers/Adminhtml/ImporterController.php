...
class Betaoutexport_Exporter_Adminhtml_ImporterController extends Mage_Adminhtml_Controller_Action
{
	...
	public function importOrdersAction() 
	{
	   if($_FILES['order_csv']['name'] != '') {
			...
			try {	
				...
				$path = Mage::getBaseDir('media') . DS.'betaoutexport/exporter/import/';
