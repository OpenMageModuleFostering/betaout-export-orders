...
class Betaoutexport_Exporter_Adminhtml_ExporterController extends Mage_Adminhtml_Controller_Action
{
	...
	public function exportLogAction()
	{
	  ...
	  $this->_prepareDownloadResponse($file, file_get_contents(Mage::getBaseDir('var') .'/betaoutexport/exporter/'.$file));
	}
}